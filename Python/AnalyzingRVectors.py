...
csvMt1Bitmap = GeneratingRBitmaps("mt1_bitmap", csvMt1.valuesSequence)

csvTh1 = CsvReadings("D:/SEMESTR IV/PRAKTYKI/CsvR/csv1mln/th1")
csvTh1Bitmap = GeneratingRBitmaps("th1_bitmap", csvTh1.valuesSequence)

csvXor1 = CsvReadings("D:/SEMESTR IV/PRAKTYKI/CsvR/csv1mln/xor1")
csvXor1Bitmap = GeneratingRBitmaps("xor1_bitmap", csvXor1.valuesSequence)

# odczyt wektorow 10 milionowych

csvMt2 = CsvReadings("D:/SEMESTR IV/PRAKTYKI/CsvR/csv10mln/mt2")
csvMt2.valuesSequence
csvMt2Bitmap = GeneratingRBitmaps("mt2_bitmap", csvMt2.valuesSequence)

csvTh2 = CsvReadings("D:/SEMESTR IV/PRAKTYKI/CsvR/csv10mln/th2")
csvTh2.valuesSequence
csvTh2Bitmap = GeneratingRBitmaps("th2_bitmap", csvTh2.valuesSequence)

csvXor2 = CsvReadings("D:/SEMESTR IV/PRAKTYKI/CsvR/csv10mln/xor2")
csvXor2.valuesSequence
csvXor2Bitmap = GeneratingRBitmaps("xor2_bitmap", csvXor2.valuesSequence)
